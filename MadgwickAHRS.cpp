...
MadgwickAHRS::MadgwickAHRS(float inputBeta, float inputSampleFreq){
	beta = beta;
	sampleFreq = inputSampleFreq;
...
void MadgwickAHRS::getQuaternion(float* dest){
	dest[0]=q0;
	dest[1]=q1;
	dest[2]=q2;
	dest[3]=q3;
